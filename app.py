...
def backtest(valor_ur, bilhetes, odd_min, odd_max, pat_min, pat_max, ativar_patamar):
    ...
    # Ordenar resultados decrescente por Lucro e pegar Top 10
...
if st.button("Rodar Backtest"):
    ...
    st.dataframe(df_com[["Odd","Patamar (×UR)","URs Criadas","Patrimônio Final","Lucro"]])

    st.markdown("### Top 10 Resultados (sem proteção)")
    st.dataframe(df_sem[["Odd","Patamar (×UR)","URs Criadas","Patrimônio Final","Lucro"]])
